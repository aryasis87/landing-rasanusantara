  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between p-4">
        {/* Logo */}
        <Link href="/" className="text-2xl font-bold text-rice">
          LeadGenPro
        </Link>
        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-6 lg:space-x-8 text-rice text-xl">
          <Link href="#company" className="hover:text-clay transition">
            About
          </Link>
          <Link href="#leadform" className="hover:text-clay transition">
            Contact
          </Link>
        </nav>
        {/* Mobile Menu Button */}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <ul className="flex flex-col text-bark-soft text-lg items-center space-y-4 p-4">
              <li>
                <Link
                  href="#company"
                  onClick={() => setIsMenuOpen(false)}
                  className="block hover:text-clay transition"
                >
                  About
                </Link>
              </li>
